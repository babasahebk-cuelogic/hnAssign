...
(function($) {
 ...
 /* For Browser (Non Touch Device)*/
	...
	// Touch Devices
		...
		o.easingAfterHotSpotScrollingDistance = 200;
	 	o.easingAfterHotSpotScrollingDuration = 1000;
	 	o.hotSpotScrolling = true;
	 	o.scrollToAnimationDuration = 1000;

	 	jQuery(".scrollingHotSpotRight").addClass('scrollingHotSpotRightVisible');
	 	jQuery(".scrollingHotSpotRight").css('opacity',0.35);
	 	jQuery(".scrollingHotSpotLeft").addClass('scrollingHotSpotLeftVisible');
	 	jQuery(".scrollingHotSpotLeft").css('opacity',0.35);
	 	
	 	el.data("scrollingHotSpotRight").bind("touchstart", function(e) {
      self._showHideHotSpots()
	    	if (o.hotSpotScrolling) {
        var x = e.pageX - $(this).offset().left;
				el.data("scrollXPos", Math.round((x / el.data("hotSpotWidth")) * o.hotSpotScrollingStep));
          ...
          self._showHideHotSpots()
          el.data("scrollingHotSpotRight").bind("touchend");
           self._trigger("scrollerRightLimitReached");
          self.hideHotSpotBackgrounds(0);
				}
				self._trigger("mouseOverRightHotSpot")
        ...
        el.data("scrollXPos", 0);
	     ...
	     el.data("scrollingHotSpotLeft").bind("touchstart", function(e) {
         self._showHideHotSpots()
	    	if (o.hotSpotScrolling) {
				var x = el.data("hotSpotWidth") - (e.pageX - $(this).offset().left);
				el.data("scrollXPos", Math.round((x / el.data("hotSpotWidth")) * o.hotSpotScrollingStep));
				...
				self.stopAutoScrolling();
						if (el.data("scrollXPos") > 0 && el.data("enabled")) {
							...
							self._showHideHotSpots();
              el.data("scrollingHotSpotLeft").bind("touchend");
     ...
     switch (o.visibleHotSpotBackgrounds) {
      ...
      case "onStart":
       ...
       el.data("hideHotSpotBackgroundsInterval", setTimeout(function() {
        self.hideHotSpotBackgrounds(10)
      ...
      case "hover":
       el.mouseenter(function(event) {
        if (o.hotSpotScrolling) {
         ...
         self.showHotSpotBackgrounds(10)
         event.stopPropagation();
        }
